...
CREATE TABLE provides (  name TEXT,  flags TEXT,  epoch TEXT,  version TEXT,  release TEXT,  pkgKey CHAR(65) , provideKey CHAR(65) PRIMARY KEY);
CREATE TABLE packages_provides ( pkgKey CHAR(65), provideKey CHAR(65));
CREATE TABLE requires (  name TEXT,  flags TEXT,  epoch TEXT,  version TEXT,  release TEXT,  pkgkey CHAR(65) , pre BOOLEAN DEFAULT FALSE, requirekey CHAR(65) PRIMARY KEY);
CREATE TABLE packages_requires ( pkgkey CHAR(65), requirekey CHAR(65) );
