...
package ARPM_DB_Containers is 
    ...
    procedure Save_Provides(RPM : in ARPM_RPM_Access; DB : in ARPM_DB_Container_Access);
    procedure Save_requires(RPM : in ARPM_RPM_Access; DB : in ARPM_DB_Container_Access);
